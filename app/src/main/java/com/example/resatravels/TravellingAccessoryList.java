...
public class TravellingAccessoryList extends ArrayAdapter<TravellingAccessory> {
   ...
   public TravellingAccessoryList(Activity context, List<TravellingAccessory> travellingAccessoryList){
        super(context,R.layout.activity_travelling_accesssory_admin1, travellingAccessoryList);
